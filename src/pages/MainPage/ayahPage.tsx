...
class AyahPage extends React.Component<IProps, never> {
  getOGComponent = () => {
    ...
    if (surah && ayah) {
      ogTitle =
        `Surat ${surahs[surah].latin} Ayah ${ayah} - ` +
        `سورة ${surahs[surah].arabic} آيه ${parseInt(ayah).toLocaleString(
          'ar-EG'
        )} `;
          ...
          {surah &&
            ayah && [
              ...
              <meta
                ...
                content={
                  this.props.currentAyah.textSimple +
                  '. \n \n' +
                  this.props.currentAyah.translations[0].text
                }
              />,
              <meta
...
export default injectIntl(AyahPage);
