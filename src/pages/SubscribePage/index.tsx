  ...
  public render() {
    ...
    return (
      <Container>
        <Helmet>
          <title>
            {intl.formatMessage({ id: KEYS.SUBSCRIBE_PAGE_TEMPLATE_TITLE })}
          </title>
        </Helmet>
        <Navbar />
        <div className="content">
                ...
                <div className="clear">
                  <input
                    ...
                    value={intl.formatMessage({
                      id: KEYS.SUBSCRIBE_PAGE_EMAIL_BUTTON_TEXT,
                    })}
                    name="subscribe"
          ...
          <div id="share">
            ...
            <a
              ...
              href="https://facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftarteel.io%2F"
              target="_blank"
              aria-label=""
            >
